...
python $HOME/converter/megatron-converter.py  -src $MEGA_CKPT/model_optim_rng.pt  -dst $HOME/models/untrained_tape/pytorch_model.bin  -out $HOME/models/out/pytorch_model.bin -dtp torch.float32 -hidden 1024 -heads 16 -layers 16
